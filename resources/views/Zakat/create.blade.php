 ...
 <div x-cloak x-show="isOpen" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0 scale-95"
     ...
     <div
         ...
         <!-- Formulir Campaign -->
         <form id="zakatForm" action="{{ route('zakat.store') }}" method="POST" enctype="multipart/form-data" class="overflow-y-auto">
             @csrf
             <div>
                 ...
                 <div>
                     ...
                     <input type="text" name="category_name" id="category_name"
                         ...
                         placeholder="Masukkan nama zakat..." required>
                     <p id="errorMessage" class="text-red-500 text-sm mt-1 hidden">
                         zakat ini sudah ada.</p>
                 </div>
                 <div class="mt-4">
